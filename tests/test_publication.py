...
@pytest.mark.parametrize("url", ["javascript:alert(1)", "http://127.0.0.1/", "http://169.254.169.254/", "https://localhost/", "https://secret@example.org/", "https://server.internal/", "https://host.test/", "https://example.org:9000/"])
